...
vmslice1.setTimeSettings(samples_per_mode, break_between_modes, startTime)
...
def RequestDataDescription(datadescription):
    ...
    # pipeline.
    vmslice1.RequestDataDescription(datadescription)
...
def DoCoProcessing(datadescription):
    ...
    '''
    vmslice1.DoCoProcessing(datadescription)
    #savedata.DoCoProcessing(datadescription)
